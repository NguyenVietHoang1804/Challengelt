        ...
        <div className="container mx-auto mb-32">
            ...
            <section className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {challenges.map((challenge) => (
                    ...
                    >
                        ...
                        <p className="text-2xl text-gray-500">Tác giả: {challenge.createdBy || 'Không xác định'}</p>
                    </Link>
                ))}
            </section>
            ...
            <div className="flex justify-center mt-6">
                ...
                {Array.from({ length: totalPages }, (_, index) => index + 1).map((page) => (
                    <button
                        key={page}
                        className={`px-3 py-1 ${page === currentPage ? 'bg-blue-500 text-white' : 'bg-gray-300 hover:bg-gray-400'}`}
